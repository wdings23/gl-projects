...
#if defined( USE_VBO )
        WTFASSERT2( pBucket->miVBO > 0 && pBucket->miVBO < 200, "invalid bucket VBO" );
        glBindBuffer( GL_ARRAY_BUFFER, pBucket->miVBO );
                                 ...
                                 bool bBlending )
{
	...
	WTFASSERT2( pBucket->miVBO > 0 && pBucket->miVBO < 200, "invalid vbo for bucket" );
                               ...
                               bool bBlending )
{
	...
	if( iLastBucket >= 0 )
	{
		...
		{
			WTFASSERT2( pLastBucket->miVBO > 0 && pLastBucket->miVBO < 200, "invalid vbo for bucket" );
