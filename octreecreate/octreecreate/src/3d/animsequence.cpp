                       ...
                       CFactory<tQuaternion>* pQuaternionFactory )
{
    ...
    if( bLoaded )
    {
        ...
        TiXmlNode* pNode = doc.FirstChild( "jointKeyframe" )->FirstChild( "data" )->FirstChild( "keyframe" );
        while( pNode )
        {
        ...
        int iFrame = 0;
        pNode = doc.FirstChild( "jointKeyframe" )->FirstChild( "data" )->FirstChild( "keyframe" );
        while( pNode )
        {
